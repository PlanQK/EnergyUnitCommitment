...
class PypsaFico(PypsaBackend):
    """
    This class is stub for using the commercial FICO Xpress solver to solve
    the linear program that is generated by pyspsa.
    """
    pass
...
class PypsaGlpk(PypsaBackend):
    """
    This class uses the GLPK solver (https://www.gnu.org/software/glpk/)
    to solve the linear program that is generated by pypsa. It is installed
    in the docker image and requires no additional setup.
    """
    pass
