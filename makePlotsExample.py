"""
This file is an example how to use plot_results.py to generate plots of the otpimization runs
This involves two step. The first have to load a data set. We can use that data to make PlotAgent
...
trough the various results folders using glob expression. You can also apply filter to the search results
which will filter out all result files who don't have values specified you. If you have a lot of optimzation
...
end all results will be saved in a pandas data frame
...
activates the appropiate environment for you
"""
...
def __main__():
    ...
    # In order to search the result folders, the PlotAgent requires a dictionary when instantiating it.
